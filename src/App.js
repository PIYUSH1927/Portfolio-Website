...
export function App() {
  ...
  useEffect(()=>{
    const typed = new Typed(el.current,{
      strings:["Full-Stack Developer💻","AWS Cloud Practitioner☁️","Data Science Enthusiast📊"
    ],startDelay:0,
    typeSpeed:80,
    backSpeed:30,
    backDelay:150,
  ...
  return (
    <div className="App">
      ...
      <a href="#Testimonial" className="mx-4 nav-items" onClick={()=>setopennav(false)}>Testimonial</a>
      ...
      <div className="col-lg-5 col-md-6 col-sm-12">
        <div className="d-flex flex-column justify-content-center Im-text-section">
          <div className="mx-2 nav-items yo">
            <a href="https://www.facebook.com/piyush.padia.5/" target="_blank">
          ...
          <span className="Im-text-subheading">
            Knack of building applications with fornt-end and back-end operations.
          </span>
          <div className="d-flex flex-row justify-content-center mt-5">
            <a href="#contactme" className="btn-hire-me">Hire me</a>
            <a href="https://drive.google.com/file/d/1o9tptzCwbnJ8evzJ0GIhsjNU1tL8S5oR/view?usp=sharing" className="btn-resume-me" target="_blank">Get Resume</a>
          </div>
        </div>
      </div>
  ...
  <br/>
      ...
      <div className="d-flex flex-column">
        ...
        <div className="col-lg-6 col-md-6 col-sm-12 py-5 d-flex flex-column">
          <span className="some-text-about-me">
            ...
            maxime id aut assumenda deleniti praesentium eum enim quas numquam.
            at consequatur totam! Adipisci, deleniti velit mollitia quibusdam 
            quis qui eaque esse assumenda. Ipsam iusto nostrum non tenetur, 
    ...
    <div className="resume-outer-section d-flex flex-column">
      ...
      <div className="resume-new-section row" style={{ width: "70%", marginInline:"auto" }}>
          ...
          <div className="d-flex flex-column">
            ...
            <span className={ workhistory === false ? "resume-options-items" : "selected resume-options-items" } onClick={() => { ChangeState(setworkhistory ,true);}} >Work</span>
    ...
    <div className="testimonials-part my-5">
      <div className="testimonials-inner-part d-flex flex-column"> 
        <span className="about-me-text" id="Testimonial">Testimonials</span>
        <span className="why-text-sub mb-5">What clients say about me{" "}</span>
        <Testimonials />
      </div>
    </div>
    <br />
    ...
    <div className="contact-me-part" id="contactme">
      ...
      <div classNamw="contact-inner-part d-flex flex-column">
        ...
        <span className="touch-text mb-5">Lets Keep in Touch</span>
        <Contact />
      </div>
    </div>
    ...
    <div className="mx-2 nav-items yo">
            <a href="https://www.facebook.com/piyush.padia.5/" target="_blank">
              <i className="fa fa-facebook-square mx-4"></i>
            </a>
            <a href="https://www.linkedin.com/in/piyush-padia-a47766215/" target="_blank">
